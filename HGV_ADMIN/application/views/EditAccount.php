...
<?php echo form_open('Hgv_controller/edit/'.$hgv_user['user_id'],array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="username" class="col-md-4 control-label">Username</label>
		<div class="col-md-8">
			<input type="text" name="username" value="<?php echo ($this->input->post('username') ? $this->input->post('username') : $hgv_user['username']); ?>" class="form-control" id="username" />
		</div>
	</div>
	<div class="form-group">
		<label for="password" class="col-md-4 control-label">Password</label>
		<div class="col-md-8">
			<input type="password" name="password" value="<?php echo ($this->input->post('password') ? $this->input->post('password') : $hgv_user['password']); ?>" class="form-control" id="password" />
		</div>
	</div>
	<div class="form-group">
				...
				<select name="user_type" class="form-control">
					<option value="">select</option>
                                            <?php 
                                                ...
                                                {
                                                        $selected = ($value == $hgv_user['user_type']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="first_name" value="<?php echo ($this->input->post('first_name') ? $this->input->post('first_name') : $hgv_user['first_name']); ?>" class="form-control" id="first_name" />
		</div>
	</div>
	<div class="form-group">
		<label for="last_name" class="col-md-4 control-label">Last Name</label>
		<div class="col-md-8">
			<input type="text" name="last_name" value="<?php echo ($this->input->post('last_name') ? $this->input->post('last_name') : $hgv_user['last_name']); ?>" class="form-control" id="last_name" />
		</div>
	</div>
	...
	<div class="form-group">
			...
			<div class="col-md-8">
				<select name="branch_id" class="form-control">
					...
					{
						$selected = ($value == $hgv_user['branch_id']) ? ' selected="selected"' : "";
